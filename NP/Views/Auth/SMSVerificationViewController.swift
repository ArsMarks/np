...
class SMSVerificationViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        bottomLine.frame = CGRect(x: 0.0, y: smsVerificationView.smsCodeTextField.frame.size.height - 2.0, width: smsVerificationView.smsCodeTextField.frame.size.width, height: 1.0)
