...
class ReserveFormViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setupData()
        [reserveFormView.phoneTextField,
         reserveFormView.nameTextField,
         reserveFormView.commentTextField].forEach { fields in
        ...
        [reserveFormView.nameTextField,
         ...
         reserveFormView.commentTextField].forEach { fields in
            ...
            bottomLine.frame = CGRect(x: 0.0,
                                      y: fields.frame.size.height - 1.0,
                                      width: fields.frame.size.width,
                                      height: 0.5)
